...
public class WorkerTwo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        channel.queueDeclare(PublishProvider.QUEUE_NAME_02, false, false, true, null);

        DefaultConsumer defaultConsumer = new DefaultConsumer(channel) {
            @Override
            public void handleDelivery(String consumerTag, Envelope envelope,
                                       AMQP.BasicProperties properties, byte[] body) throws IOException {
                System.out.println("Worker Two receive msg : " + new String(body));
            }
        };
        channel.basicConsume(PublishProvider.QUEUE_NAME_02, true, defaultConsumer);
    }
}
